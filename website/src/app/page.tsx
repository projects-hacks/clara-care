            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-700 to-violet-800 pb-24 pt-32 md:pb-36 md:pt-44">
                ...
                <div className="relative mx-auto max-w-5xl px-6 text-center">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <a
                            href="https://apps.apple.com/app/claracare"
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-blue-700 via-indigo-700 to-violet-800 py-24">
                ...
                <FadeIn className="relative mx-auto max-w-3xl px-6 text-center">
                    ...
                    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        ...
                        <a
                            href="https://play.google.com/store/apps/details?id=com.claracare"
                            className="group flex items-center gap-2 rounded-full bg-white/10 px-8 py-4 text-base font-bold text-white ring-1 ring-white/20 transition-all hover:-translate-y-0.5 hover:bg-white/20 active:scale-95"
                        >
                ...
                <div className="mx-auto max-w-6xl px-6">
                    <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                        ...
                        <div className="flex gap-6 text-sm text-gray-500">
                            ...
                            <a href="mailto:hello@claracare.me" className="transition-colors hover:text-gray-900">Contact</a>                        </div>
                    </div>
                </div>
            </footer>
        </div>
